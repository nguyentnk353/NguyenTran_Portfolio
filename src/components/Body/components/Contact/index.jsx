...
const index = () => {
  return (
    <div>
      <section className="contact lg:min-h-[91vh] lg:pt-[30vh] pb-16 lg:pb-0 box-border">
        <div className="flex flex-col justify-center m-auto">
          <p className="text-center">Get in Touch</p>
          <h1 className="text-center text-[3rem] mb-8">Contact Me</h1>
          <div className="flex lg:flex-row flex-col justify-center border-2 border-gray-500 p-4 m-auto rounded-[2rem] gap-4">
